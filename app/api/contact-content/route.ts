...
import { ContactContent } from '@/lib/models';
import { ObjectId } from 'mongodb';

// GET - Fetch all contact content
export async function GET() {
  try {
    const db = await getDatabase();
    const collection = db.collection<ContactContent>('contact_content');
...
// POST - Create or update contact content
